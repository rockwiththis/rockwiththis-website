...
import './stylesheets/subgenre-badge.scss'
...
class ControlBar extends Component {
  ...
  // TODO once we replace `dance/electronic` w/ `electronic`, stop using this
  getGenreClass = subgenre => subgenre.parentGenreName === 'dance/electronic' ?
    'electronic' : subgenre.parentGenreName
          ...
          <div className={`control-bar ${this.props.isControlBarFixed ? 'fixed-control-bar' : ''}`}>
            ...
            */}
            ...
            <div className="active-filters">
              { this.props.subgenreFilters.map(subgenre => (
                <div className={`genre-badge subgenre-badge ${this.getGenreClass(subgenre)}`}>
...
export default connect(
  ({ discoverLayout, isShuffle, subgenreFilters }) => ({
    discoverLayout,
    isShuffle,
    subgenreFilters
  }),

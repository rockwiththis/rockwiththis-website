...
class FooterAudioPlayer extends Component {
  ...
  constructor(props) {
    super(props);
    this.state = { fullMobilePlayer: false };
  }
        ...
        <div className="player-controls">
          ...
          <div className="player-duration-bar-wrapper">
            ...
            <div className="player-duration-bar-current-time">
              { formatTime(this.props.activeSongProgress.playedSeconds) }
            </div>
            ...
            <div className="player-duration-bar-song-duration">
              {(this.props.activeSongDuration) ? formatTime(this.props.activeSongDuration) : "0:00"}
            </div>
  ...
  renderSoundCloud = () => {
    ...
    return (
        <div>
          {this.props.activeSong.soundcloud_link ?
            <a target="_blank" href={`${this.props.activeSong.soundcloud_link}`} className="source soundcloud">
  ...
  renderYoutube = () => {
    ...
    return (
        <div>
          {this.props.activeSong.youtube_link ?
            <a target="_blank" href={`${this.props.activeSong.youtube_link}`} className="source youtube">
  ...
  renderSongSource = () =>
    <div className="songSourceContainer">
      {this.props.activeSong.soundcloud_track_id ?
        this.renderSoundCloud() : <div></div>
      }
      {this.props.activeSong.youtube_track_id ?
        this.renderYoutube() : <div></div>
      }
    </div>;
      ...
      return (
          <footer>
            <div className="footer-player">
              <div className="player-controls-wrapper"></div>
            </div>
          </footer>
      );
    }
